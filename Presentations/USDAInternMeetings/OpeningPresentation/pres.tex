...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[width=\linewidth]{auburn_visit.jpg}
\column{0.5\textwidth}
\includegraphics[width=\linewidth]{mins_machine_galina.jpg}
\end{columns}
\vspace{1em}
\small
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[width=\linewidth]{mins_mcnp_slice.jpg}
\column{0.5\textwidth}
\includegraphics[width=\linewidth]{mins_3d.jpg}
\end{columns}
\vspace{1em}
\begin{itemize}
...
\begin{center}
\includegraphics[width=0.7\linewidth]{1x1x1vs7x7x7.jpg}
\end{center}
\small
...
\frametitle{Analysis}
\begin{center}
\includegraphics[width=0.7\linewidth]{analysis_methods.jpg}
\end{center}
\small
...
\begin{center}
\includegraphics[width=0.7\linewidth]{detector_range.jpg}
\end{center}
\small
